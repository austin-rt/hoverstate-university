...
const AssignCourseModal = ({
	...
	return (
		<div className="fixed w-2/3 max-w-md h-1/3 flex flex-col justify-start bg-gradient-to-br from-slate-600 to-slate-800 rounded-lg border border-solid border-cyan-600">
			<div>
